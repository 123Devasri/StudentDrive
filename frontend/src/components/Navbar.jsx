function Navbar({ onMenuClick }) {
  return <header className="topbar d-flex align-items-center justify-content-between px-3 px-lg-4">
    ...
    <div className="d-flex align-items-center gap-3">
      ...
      <div className="profile"><span>DS</span><div className="d-none d-sm-block">
        <strong>Deva Sri</strong><small>Student</small></div><i className="bi bi-chevron-down d-none d-sm-block" /></div></div>
  </header>;
}
